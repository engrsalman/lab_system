...
@section('content')
    ...
    <div class="row">
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
                 <h4 class="m-t-0 header-title"><b>Update User Report</b></h4>
                 <br/>
        ...
        @endif
             ...
             <form action="{{route('report.update',['id'=>$userreport->id])}}" Method="POST" data-parsley-validate="" novalidate="">
              @csrf()
              @method('patch')
                    <div class="row">
                         <div class="col-md-3">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                            ...
                            <input type="text" name="result" parsley-trigger="change" required="" class="form-control" id="result"  value="{{$userreport->result}}">
                            </div>
                        </div>
                     </div>
