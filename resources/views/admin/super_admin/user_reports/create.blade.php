...
@section('content')
    ...
    <div class="row">
        ...
        @endif
             ...
             <form action="{{route('store.report')}}" Method="POST" data-parsley-validate="" novalidate="">
              @csrf()     
                    <div class="row">
                         <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                            ...
                            <input type="date" name="reg_date" parsley-trigger="change" required="" value="{{ date('Y-m-d') }}" class="form-control" id="reg_date">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="time" name="reg_number" parsley-trigger="change" required="" value="<?php echo time();?>"  class="form-control" id="reg_number">
                            </div>
                        </div>
                     </div>
                     <div class="row">
