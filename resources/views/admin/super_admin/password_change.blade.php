...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                <form action="{{route('superadmin.password_submit')}}" method="post">
                    @csrf
                    <div class="form-group">
                        <label for="">Old password <span class="required-field"> *</span></label>
                        <input type="password" name="old_password" required placeholder="Enter old password" class="form-control">
                        @error('old_password')
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" required placeholder="Enter new password" class="form-control">
                        @error('password')
                        <span class="invalid-feedback" role="alert">
                          <small>{{ $message }}</small>
                        </span>
